...
namespace GeneratedCode
{
    public class GeneratedClass
    {
        ...
        private void GenerateWorkbookPart1Content(WorkbookPart workbookPart1)
        {
            ...
            FileVersion fileVersion1 = new FileVersion() { ApplicationName = "xl", LastEdited = "7", LowestEdited = "7", BuildVersion = "22730" };
            ...
            OpenXmlUnknownElement openXmlUnknownElement1 = OpenXmlUnknownElement.CreateOpenXmlUnknownElement("<x15ac:absPath xmlns:x15ac=\"http://schemas.microsoft.com/office/spreadsheetml/2010/11/ac\" url=\"C:\\Users\\zaaza\\Desktop\\\" />");

            alternateContentChoice1.Append(openXmlUnknownElement1);

            alternateContent1.Append(alternateContentChoice1);

            OpenXmlUnknownElement openXmlUnknownElement2 = OpenXmlUnknownElement.CreateOpenXmlUnknownElement("<xr:revisionPtr revIDLastSave=\"0\" documentId=\"8_{B5654AA1-CCE1-4530-8070-D375FBB279A6}\" xr6:coauthVersionLast=\"45\" xr6:coauthVersionMax=\"45\" xr10:uidLastSave=\"{00000000-0000-0000-0000-000000000000}\" xmlns:xr10=\"http://schemas.microsoft.com/office/spreadsheetml/2016/revision10\" xmlns:xr6=\"http://schemas.microsoft.com/office/spreadsheetml/2016/revision6\" xmlns:xr=\"http://schemas.microsoft.com/office/spreadsheetml/2014/revision\" />");

            BookViews bookViews1 = new BookViews();

            WorkbookView workbookView1 = new WorkbookView() { XWindow = -33105, YWindow = 8265, WindowWidth = (UInt32Value)21135U, WindowHeight = (UInt32Value)23535U };
            workbookView1.SetAttribute(new OpenXmlAttribute("xr2", "uid", "http://schemas.microsoft.com/office/spreadsheetml/2015/revision2", "{CBA7D845-BCB4-4CEA-A9E5-8EEEBBED9CD2}"));
        ...
        private void GenerateWorkbookStylesPart1Content(WorkbookStylesPart workbookStylesPart1)
        {
            ...
            CellFormat cellFormat3 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)1U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)1U, FormatId = (UInt32Value)0U, ApplyFont = true, ApplyBorder = true, ApplyAlignment = true };
            ...
            OpenXmlUnknownElement openXmlUnknownElement5 = OpenXmlUnknownElement.CreateOpenXmlUnknownElement("<x15:timelineStyles defaultTimelineStyle=\"TimeSlicerStyleLight1\" xmlns:x15=\"http://schemas.microsoft.com/office/spreadsheetml/2010/11/main\" />");

            stylesheetExtension2.Append(openXmlUnknownElement5);
        ...
        private void GenerateThemePart1Content(ThemePart themePart1)
        {
            ...
            OpenXmlUnknownElement openXmlUnknownElement6 = OpenXmlUnknownElement.CreateOpenXmlUnknownElement("<thm15:themeFamily xmlns:thm15=\"http://schemas.microsoft.com/office/thememl/2012/main\" name=\"Office Theme\" id=\"{62F939B6-93AF-4DB8-9C6B-D6C7DFDC589F}\" vid=\"{4A3C46E8-61CC-4603-A589-7422A47A8E4A}\" />");

            extension1.Append(openXmlUnknownElement6);
        ...
        private void GenerateWorksheetPart1Content(WorksheetPart worksheetPart1)
        {
            ...
            worksheet1.SetAttribute(new OpenXmlAttribute("xr", "uid", "http://schemas.microsoft.com/office/spreadsheetml/2014/revision", "{8586BF2A-F0AC-4DF3-B17A-0E127DFFE7FA}"));
            SheetDimension sheetDimension1 = new SheetDimension() { Reference = "A1:E5" };

            SheetViews sheetViews1 = new SheetViews();

            SheetView sheetView1 = new SheetView() { TabSelected = true, WorkbookViewId = (UInt32Value)0U };
            Selection selection1 = new Selection() { ActiveCell = "C4", SequenceOfReferences = new ListValue<StringValue>() { InnerText = "C4" } };
            ...
            Row row1 = new Row() { RowIndex = (UInt32Value)1U, Spans = new ListValue<StringValue>() { InnerText = "1:5" }, DyDescent = 0.25D };
            ...
            Cell cell6 = new Cell() { CellReference = "A2", StyleIndex = (UInt32Value)2U };

            Cell cell7 = new Cell() { CellReference = "B2", StyleIndex = (UInt32Value)2U, DataType = CellValues.SharedString };
            CellValue cellValue2 = new CellValue();
            cellValue2.Text = "1";

            cell7.Append(cellValue2);

            Cell cell8 = new Cell() { CellReference = "C2", StyleIndex = (UInt32Value)2U, DataType = CellValues.SharedString };
            CellValue cellValue3 = new CellValue();
            cellValue3.Text = "2";

            cell8.Append(cellValue3);

            Cell cell9 = new Cell() { CellReference = "D2", StyleIndex = (UInt32Value)2U, DataType = CellValues.SharedString };
            CellValue cellValue4 = new CellValue();
            cellValue4.Text = "7";

            cell9.Append(cellValue4);

            Cell cell10 = new Cell() { CellReference = "E2", StyleIndex = (UInt32Value)2U, DataType = CellValues.SharedString };
            CellValue cellValue5 = new CellValue();
            cellValue5.Text = "3";

            cell10.Append(cellValue5);
            ...
            Cell cell12 = new Cell() { CellReference = "B3", StyleIndex = (UInt32Value)2U, DataType = CellValues.SharedString };
            CellValue cellValue7 = new CellValue();
            cellValue7.Text = "4";

            cell12.Append(cellValue7);

            Cell cell13 = new Cell() { CellReference = "C3", StyleIndex = (UInt32Value)2U };
            CellValue cellValue8 = new CellValue();
            cellValue8.Text = "10";

            cell13.Append(cellValue8);

            Cell cell14 = new Cell() { CellReference = "D3", StyleIndex = (UInt32Value)2U };
            CellValue cellValue9 = new CellValue();
            cellValue9.Text = "50";

            cell14.Append(cellValue9);

            Cell cell15 = new Cell() { CellReference = "E3", StyleIndex = (UInt32Value)2U };
            CellFormula cellFormula1 = new CellFormula();
            cellFormula1.Text = "C3*D3";
            CellValue cellValue10 = new CellValue();
            cellValue10.Text = "500";

            cell15.Append(cellFormula1);
            cell15.Append(cellValue10);
            ...
            Cell cell16 = new Cell() { CellReference = "A4", StyleIndex = (UInt32Value)2U };
            CellValue cellValue11 = new CellValue();
            cellValue11.Text = "2";

            cell16.Append(cellValue11);

            Cell cell17 = new Cell() { CellReference = "B4", StyleIndex = (UInt32Value)2U, DataType = CellValues.SharedString };
            CellValue cellValue12 = new CellValue();
            cellValue12.Text = "5";

            cell17.Append(cellValue12);

            Cell cell18 = new Cell() { CellReference = "C4", StyleIndex = (UInt32Value)2U };
            CellValue cellValue13 = new CellValue();
            cellValue13.Text = "20";

            cell18.Append(cellValue13);

            Cell cell19 = new Cell() { CellReference = "D4", StyleIndex = (UInt32Value)2U };
            CellValue cellValue14 = new CellValue();
            cellValue14.Text = "100";

            cell19.Append(cellValue14);

            Cell cell20 = new Cell() { CellReference = "E4", StyleIndex = (UInt32Value)2U };
            CellFormula cellFormula2 = new CellFormula() { FormulaType = CellFormulaValues.Shared, Reference = "E4:E5", SharedIndex = (UInt32Value)0U };
            cellFormula2.Text = "C4*D4";
            CellValue cellValue15 = new CellValue();
            cellValue15.Text = "2000";

            cell20.Append(cellFormula2);
            cell20.Append(cellValue15);
            ...
            Cell cell21 = new Cell() { CellReference = "A5", StyleIndex = (UInt32Value)2U };
            CellValue cellValue16 = new CellValue();
            cellValue16.Text = "3";

            cell21.Append(cellValue16);

            Cell cell22 = new Cell() { CellReference = "B5", StyleIndex = (UInt32Value)2U, DataType = CellValues.SharedString };
            CellValue cellValue17 = new CellValue();
            cellValue17.Text = "6";

            cell22.Append(cellValue17);

            Cell cell23 = new Cell() { CellReference = "C5", StyleIndex = (UInt32Value)2U };
            CellValue cellValue18 = new CellValue();
            cellValue18.Text = "30";

            cell23.Append(cellValue18);

            Cell cell24 = new Cell() { CellReference = "D5", StyleIndex = (UInt32Value)2U };
            CellValue cellValue19 = new CellValue();
            cellValue19.Text = "30";

            cell24.Append(cellValue19);

            Cell cell25 = new Cell() { CellReference = "E5", StyleIndex = (UInt32Value)2U };
            CellFormula cellFormula3 = new CellFormula() { FormulaType = CellFormulaValues.Shared, SharedIndex = (UInt32Value)0U };
            cellFormula3.Text = "";
            CellValue cellValue20 = new CellValue();
            cellValue20.Text = "900";

            cell25.Append(cellFormula3);
            cell25.Append(cellValue20);
        ...
        private void GenerateCalculationChainPart1Content(CalculationChainPart calculationChainPart1)
        {
            ...
            CalculationCell calculationCell1 = new CalculationCell() { CellReference = "E4", SheetId = 1, NewLevel = true };
            CalculationCell calculationCell2 = new CalculationCell() { CellReference = "E5", SheetId = 1 };
            CalculationCell calculationCell3 = new CalculationCell() { CellReference = "E3", SheetId = 1 };
        ...
        {
            document.PackageProperties.Creator = "Андрей Заярный";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2020-07-22T16:11:57Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2020-07-22T16:13:44Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Андрей Заярный";
        }

        #region Binary Data
        private string spreadsheetPrinterSettingsPart1Data = "";
